...
{
    public partial class InitialCoffeeShopSchema : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_auth_activities_app_users_user_id",
                        column: x => x.user_id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_orders_app_users_created_by_user_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_reviews_app_users_user_id",
                        column: x => x.user_id,
                        principalTable: "app_users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_user_cart_items", x => x.id);
                    table.ForeignKey(
                        name: "fk_user_cart_items_app_users_user_id",
                        column: x => x.user_id,
                        principalTable: "app_users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_user_cart_items_products_product_id",
                        column: x => x.product_id,
                        principalTable: "products",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    line_total = table.Column<decimal>(type: "numeric", nullable: false, computedColumnSql: "unit_price * quantity", stored: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "ix_auth_activities_user_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_user_cart_items_product_id",
                table: "user_cart_items",
                column: "product_id");

            migrationBuilder.CreateIndex(
                name: "ix_user_cart_items_user_id_product_id",
                table: "user_cart_items",
